...
func (g *Generator) GenerateFile() {
	...
	g.P("// Versions:")
	g.P("// - protoc-gen-go-vsrpc: ", g.PluginVersion())
...
func (g *Generator) PluginVersion() string {
	str := Version
...
func (g *Generator) GenerateClientMethod(service *protogen.Service, method *protogen.Method, implName string) {
	...
	g.P()
	g.P("\tstream := ", CorePackage.Ident("NewStream"), "[*", mp.In.GoIdent, ", *", mp.Out.GoIdent, "](call)")
...
func (g *Generator) GenerateHandlerCase(service *protogen.Service, method *protogen.Method) {
	...
	if !mp.In.IsNullary || !mp.Out.IsNullary {
		g.P("\t\tstream := ", CorePackage.Ident("NewStream"), "[*", mp.Out.GoIdent, ", *", mp.In.GoIdent, "](call)")
	}
	if mp.In.IsSingular {
